package es.flores.microservices.composite.screen;
...
public class ScreenCompositeServiceApplication {
  ...
  */
  ...
  public ScreenCompositeServiceApplication(
  ...
  public static void main(String[] args) {
    SpringApplication.run(ScreenCompositeServiceApplication.class, args);
  }
